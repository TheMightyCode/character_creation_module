...
def start_training(char_class: str) -> Character:
    """
    Принимает на вход имя и класс персонажа.
    Возвращает сообщения о результатах цикла тренировки
    персонажа.
    """
    commands = {'attack': char_class.attack, 'defence': char_class.defence,
